...
export default function RecipesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background text-gray-800 dark:text-slate-100 p-6 space-y-6">
      {/* ── Clean Header ── */}
      <header className="bg-white dark:bg-card p-4 rounded-lg border border-gray-200 dark:border-white/5">
        <h1 className="text-lg font-bold text-gray-800 dark:text-white">Recipe Management</h1>
