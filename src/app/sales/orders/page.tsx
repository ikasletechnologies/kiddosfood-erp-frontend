          ...
          {readOnly ? (
            ...
            <>
              <button
                ...
                className="px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-semibold border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg text-gray-600 dark:text-slate-300 transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-semibold border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg text-gray-700 dark:text-slate-200 transition-colors disabled:opacity-50 cursor-pointer"
              >
                Save as Draft
              </button>
              <button
                ...
                className="px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-semibold border border-orange-200 dark:border-orange-500/20 hover:bg-orange-50 dark:hover:bg-orange-500/10 rounded-lg text-[#f58220] transition-colors cursor-pointer"
              >
                Share
              </button>
              <button
