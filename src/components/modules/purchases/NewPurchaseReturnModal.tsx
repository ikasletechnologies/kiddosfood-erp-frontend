...
export default function NewPurchaseReturnModal({ vendors, onClose, onSuccess }: { vendors: any[], onClose: () => void, onSuccess: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="bg-white dark:bg-[#12141c] rounded-[2.5rem] shadow-2xl w-full max-w-2xl p-10 space-y-8 relative overflow-hidden">
         ...
         <div className="flex justify-between items-start relative z-10">
           ...
           <button type="button" onClick={onClose} className="p-2 bg-gray-50 rounded-full hover:bg-gray-100 text-gray-400">
              <X size={18} />
           </button>
         </div>
        ...
        <form onSubmit={handleCreate} className="space-y-6 relative z-10">
          ...
          <div>
            <div className="flex items-center justify-between mb-3 px-1">
              ...
              <button type="button" onClick={addItem} className="text-orange-600 text-[10px] font-black uppercase tracking-widest hover:text-orange-700">+ Add Row</button>
            </div>
