...
// Minimal quick-add — the full Customer form (GST, credit limit, addresses,
// etc.) still lives on the Customers page; this only covers what's needed to
// pick a destination on a Delivery Challan without losing the in-progress
// challan draft by navigating away.
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[60] p-4">
      <div className="bg-white rounded-lg border border-gray-200 p-5 w-full max-w-sm space-y-4 shadow-xl">
        <div className="flex justify-between items-center border-b border-gray-100 pb-3">
          <h3 className="text-sm font-bold text-gray-800">Quick Add Customer</h3>
